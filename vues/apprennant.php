...
<div class="content">
    <a href="?p=apprennantAdd" class="btn btn-primary btn-addon pull-right">
                    ...
                    <table class="table table-hover">
                        ...
                        <?php
                            ...
                            foreach ($utilisateurs as $key => $utilisateur) { 
                                 if ($utilisateur["role"]=="apprennant") {
                        ...
                        ?>
                            <tr class="element">
                                ...
                                <td class="data">
                                    <a href="?p=apprennantUpdate&id=<?= $utilisateur["id_utilisateur"] ?>" class="btn btn-info btn-xs m-r-15"><i class="fa fa-pencil"></i></a>
                                    <a href="?p=apprennantDelete&id=<?= $utilisateur["id_utilisateur"] ?>" class="btn btn-danger btn-xs"><i class="fa fa-times"></i></a>
                                </td>
                            </tr>
                        <?php } }   ?>
                        </tbody>
